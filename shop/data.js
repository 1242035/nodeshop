...
module.exports = {
    ...
    getTopCategories: function(callback){
        var query = Category.find({topnav : true}).then( function(query){
    ...
    getFeatured: function(callback) {
        ...
        var query = Product.find({featured : true}).then( function( query ) {
    ...
    getCategoryProducts: function(category, callback) {
        ...
        Category.findOne({seo : category}).then( function(categoryQuery){
    ...
    findProductBySEO: function(seo, callback) {
        var query = Product.findOne({seo : seo}).then( function(query){
    ...
    findProductByID: function(id, callback) {
        ...
        var query = Product.findOne({_id : id}).then( function(query){
            query.exec(function(err, product) {
